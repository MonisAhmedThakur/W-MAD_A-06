...
function search(){
  ...
  fetch(`https://api.openweathermap.org/data/2.5/weather?q=${input.value}&units=metric&appid=75fef9bb7eb59a11f5addd93e26ba0ec
`)
  .then(res => res.json())
  .then((res)=>{
    console.log(res);
  divWeather.innerHTML = `<div class="temp">
  <div class="header">
      ${res.name}
  </div>
  <p>Feels Like</p>
